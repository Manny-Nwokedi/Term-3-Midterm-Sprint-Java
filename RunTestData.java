...
// Import statements for Author, Book, and Patron classes
...
public class RunTestData{
    ...
    public static void main(String[] args) {
        ...
        Book updatedBook = new Book("The Washed-up Wizard", author10, "ISBN008", "Publisher8", 4);
        library.editBook(book10, updatedBook);


        library.deleteBook(updatedBook);

        Author updatedAuthor = new Author("Bob Silver", new Date(0));
        library.editAuthor(author9, updatedAuthor);
        System.out.println();
    }
    ...
    public void editAuthor(Author author) {
        library.editAuthor(author, author);
    }
